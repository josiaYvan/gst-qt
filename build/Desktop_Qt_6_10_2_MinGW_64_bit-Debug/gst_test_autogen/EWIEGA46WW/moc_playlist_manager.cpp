...
void PlaylistManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->mediaRemoved((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->currentIndexChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->playlistChanged(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (PlaylistManager::*)(const QString & )>(_a, &PlaylistManager::mediaRemoved, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (PlaylistManager::*)(int )>(_a, &PlaylistManager::currentIndexChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (PlaylistManager::*)()>(_a, &PlaylistManager::playlistChanged, 2))
            return;
    }
}
...
// SIGNAL 0
void PlaylistManager::mediaRemoved(const QString & _t1)
{
